  ...
  Future<void> _loadData() async {
    try {
      ...
      if (_dataSnapshot != null && _dataSnapshot.value != null) {
        Map<dynamic, dynamic> data = (_dataSnapshot.value as Map)['order_cancel'];
                  ...
                  child: ListTile(
                    ...
                    subtitle: Column(
                      ...
                      children: [
                        ...
                        Text('Giá: '+ price + ' VNĐ',style: TextStyle(fontSize: 15,color: Colors.white,fontWeight: FontWeight.bold),),
                        ...
                        Text('Thành tiền: '+total+ ' VNĐ',style: TextStyle(fontSize: 15,color: Colors.white,fontWeight: FontWeight.bold),),
                      ],
                    ),
                  ),
                )
