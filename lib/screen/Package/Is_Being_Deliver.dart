...
class IsBeingDeliver extends StatefulWidget {
  const IsBeingDeliver({super.key});

  @override
  State<IsBeingDeliver> createState() => _IsBeingDeliverState();
}

class _IsBeingDeliverState extends State<IsBeingDeliver> {
  @override
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text('Đang giao hàng',style: TextStyle(color: Colors.white,fontWeight: FontWeight.bold),),
        leading: IconButton(
                  ...
                  child: Row(
                    children: [
                      ...
                      Column(
                        crossAxisAlignment: CrossAxisAlignment.center,
                        children: [
                          ElevatedButton(onPressed: null, child: Text('Xem chi tiết',style: TextStyle(color: Color.fromRGBO(59, 122, 91, 1),),),style: ButtonStyle(backgroundColor: MaterialStateProperty.all<Color>(Color.fromRGBO(203, 222, 213, 1)),),),
